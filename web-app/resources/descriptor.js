...
//                }}
...

	    {
            ...
            "comp": {
                ...
                "items": [
                    { "comp": { "name": "HBox", "items": [
                        { comp : { "name": "HSpacer" }, layout: { "box-flex" : 1 } },
                        { comp: { name: 'HBox', items: [
                            { data: "title", comp: { "name": "InlineText" } },
                            { data: "price", comp: { "name": "InlineText" }, layout: { spacerBefore: 10 } }
                        ]}},
                        { comp : { "name": "HSpacer" }, layout: { "box-flex" : 1 } }
                    ]} },
			    ...
			    items: [
				    {
			            ...
			            "comp": {
			                "name": "VBox",
			                "items": [
			                    { id:'summaryTitle', "data": "title", "layout": { spacerBefore:"*", spacerAfter: 3 } ,"comp":{ name: "Label", postfix:' <span class="typeName"> | Menu</span>' } },
...
//                    { "data": "image", "layout": { spacerBefore: 10, spacerAfter: 20, "width":"50px", "height":"50px" } },
                    ...
                    },
                    {
                        ...
                        "comp": {
                            "name": "VBox",
                            "items": [
                                { id:'summaryTitle', "data": "title", "layout": { spacerBefore:"*", spacerAfter: 3 },"comp":{ name: "Label", postfix:' <span class="typeName">| Section</span>' } },
                                { id:'descript', "data": "description", comp: { name: "Label" }, "layout": { spacerAfter: 9 } }
                            ]
                        }
                    },
                    {
                ...
                "items": [
                    ...
                    },
                    {
                        ...
                        "comp": {
                            "name": "VBox",
                            "items": [
                                { id:'summaryTitle', "data": "title", "layout": { spacerBefore:"*", spacerAfter: 3 },"comp":{ name: "Label", postfix:' <span class="typeName">| Dish</span>' } },
                                { id:'descript', "data": "description", comp: { name: "Label" }, "layout": { spacerAfter: 9 } }
                            ]
                        }
                    },
                    {
                        ...
                        "comp": {
                            "name": "VBox",
                            "items": [
                                { id:'summaryPrice', "data": "price", comp: { name: "Label" }, "layout": { spacer:"*" } }
                            ]
                        }
                    }
                ]
