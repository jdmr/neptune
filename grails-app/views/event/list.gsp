			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="firstName" title="${message(code: 'event.firstName.label', default: 'First Name')}" />
					
						<g:sortableColumn property="lastName" title="${message(code: 'event.lastName.label', default: 'Last Name')}" />
				...
				<g:each in="${eventInstanceList}" status="i" var="eventInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${eventInstance.id}">${fieldValue(bean: eventInstance, field: "cost")}</g:link></td>
						...
						<td>${fieldValue(bean: eventInstance, field: "firstName")}</td>
					
						<td>${fieldValue(bean: eventInstance, field: "lastName")}</td>
